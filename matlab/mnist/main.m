...
p_x_new = @(this_data) (p_y_0*bmpdf(this_data, K, model_x_0.mu, model_x_0.w)+...
    p_y_1*bmpdf(this_data, K, model_x_1.mu, model_x_1.w)+...
    p_y_2*bmpdf(this_data, K, model_x_2.mu, model_x_2.w)+...
    p_y_3*bmpdf(this_data, K, model_x_3.mu, model_x_3.w)+...
    p_y_4*bmpdf(this_data, K, model_x_4.mu, model_x_4.w)+...
    p_y_5*bmpdf(this_data, K, model_x_5.mu, model_x_5.w)+...
    p_y_6*bmpdf(this_data, K, model_x_6.mu, model_x_6.w)+...
    p_y_7*bmpdf(this_data, K, model_x_7.mu, model_x_7.w)+...
    p_y_8*bmpdf(this_data, K, model_x_8.mu, model_x_8.w)+...
    p_y_9*bmpdf(this_data, K, model_x_9.mu, model_x_9.w)+...
    p_y_u*bmpdf(this_data, K, model_x_u.mu, model_x_u.w));
