...
legend({'Labeled, class 0', 'Labeled, class 1', 'Unlabeled, class 0', 'Unlabeled, class 1'}, 'Location', 'northoutside', 'Interpreter', 'latex');
% colorbar;
colormap(jet);
xlim([-5 5]);
ylim([-5 5]);
...
scatter(X_labeled((y_labeled==0),1), X_labeled((y_labeled==0),2), 100, 'or', 'LineWidth', 3);
scatter(X_labeled((y_labeled==1),1), X_labeled((y_labeled==1),2), 100, 'xb', 'LineWidth', 3);
legend({'Labeled, class 0', 'Labeled, class 1'}, 'Location', 'northoutside', 'Interpreter', 'latex');
% colorbar;
colormap(jet);
xlim([-5 5]);
ylim([-5 5]);
