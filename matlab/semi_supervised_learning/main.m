...
p_y_ulabeled = length(y_labeled)/(length(y_labeled) + length(y_unlabeled));
...
p_x = @(x1, x2) (p_y_0*pdf(p_xy_0, [x1 x2]) + p_y_1*pdf(p_xy_1, [x1 x2])...
    + p_y_ulabeled*pdf(p_xy_unlabeled, [x1 x2])); 
...
fcontour(@(x1, x2)(p_y_0*pdf(p_xy_0, [x1 x2]) + p_y_1*pdf(p_xy_1, [x1 x2])...
    + p_y_ulabeled*pdf(p_xy_unlabeled, [x1 x2])), [-5 5 -5 5], 'LevelList', level_list, 'LineWidth', 1)
...
fcontour(@(x1, x2)(pdf(p_xy_1, [x1, x2])/(p_y_0*pdf(p_xy_0, [x1 x2]) + p_y_1*pdf(p_xy_1, [x1 x2])...
    + p_y_ulabeled*pdf(p_xy_unlabeled, [x1 x2]))*p_y_1 ...
    - pdf(p_xy_0, [x1, x2])/(p_y_0*pdf(p_xy_0, [x1 x2]) + p_y_1*pdf(p_xy_1, [x1 x2])...
    + p_y_ulabeled*pdf(p_xy_unlabeled, [x1 x2]))*p_y_0), ...
