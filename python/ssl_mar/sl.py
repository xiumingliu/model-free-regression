...
for i in range(iteration):
    ...
    #my_plt.plot_test_sl(z_test, y_test_mle, y_test, pe_test_mle, leftout_classes)
    #my_plt.plot_test_sl_2(z_test, y_test_mle, y_test, pe_test_mle, leftout_classes)
...
plt.tight_layout()
plt.savefig("empirical_pe_sl_diag.png")
plt.savefig("empirical_pe_sl_diag.pdf", format='pdf')
